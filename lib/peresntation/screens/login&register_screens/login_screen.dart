        ...
        child: ListView(
          children: [
            ...
            Row(
              children: [
                TextButton(onPressed: () {},
                    child: TextComponent(text: "نسيت كلمة المرور ؟ ",
                      fontSize: 15.0,
                      colorText: Colors.black54,)),
                const Spacer(),
                TextComponent(
                  text: "تذكرني", fontSize: 15.0, colorText: Colors.black54,),
                Checkbox(
                  fillColor: MaterialStateProperty.all(Colors.pinkAccent),
                  shape: const CircleBorder(),
                  value:  selectChoiceCountries , onChanged: (value) {
                  /// TODO : S
                },) ,
                SpaceComponent(
            ...
            GeneralButton(
              ...
              child: TextComponent(text: "الدخول",
                fontSize: 20.0,
            ...
            GeneralButton(onPressed: () {},
              ...
              child: Row(
                ...
                children: [
                  ...
                  Image.asset("assets/fingerprint.png" ,color: Colors.pinkAccent) ,
                  SpaceComponent(
                    width: media.width * .05,
                  ),
                  TextComponent(text: " الدخول الأمن بالبصمة",
                    fontSize: 20.0,
            ...
            Row(
              ...
              children: [
                ...
                }, child: const Text("اضغط هنا للستجيل" ,style: TextStyle(color: Colors.pinkAccent ,fontWeight: FontWeight.bold),)),
                TextComponent(text: "ليس لديك حساب بعد؟" ,fontSize: 15.0 ,colorText: Colors.black87) ,
              ],
            ) ,
          ],
        ),
