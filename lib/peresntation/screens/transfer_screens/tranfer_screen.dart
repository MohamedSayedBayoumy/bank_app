      ...
      body: GeneralPadding(
        child: ListView(
          children: [
            ...
            CustomTextField(controller: TextEditingController() ,labelText: "المبلغ المراد تحويله",) ,
            SpaceComponent(height: media.height*.03,),
            CustomTextField(controller: TextEditingController() ,labelText: "المبلغ المراد استلامه",) ,
            SpaceComponent(height: media.height*.03,),

            DropList(list: data1 , value: data1Controller   ) ,
            SpaceComponent(height: media.height*.03,),

              GeneralButton(width: media.width*2 ,onPressed: (){}, child: const Text("حفظ") ,color: Colors.indigo,height: media.height*.05,) ,
          ],
        ),
      ),
    );
